"""
Merge Notion database CSV with HTML page body content.
...
This script matches each CSV row to its HTML file and adds a "Body" column
containing the raw HTML body content, producing a unified CSV.
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="Examples:\n"
               ...
               '  python3 merge_notion_db_html.py "My Database abc123/"\n'
               "\n"
    ...
    parser.add_argument(
        "--output", "-o",
        default=None,
        help="Path for the merged output CSV (default: <html_folder> - merged.csv)",
    )
